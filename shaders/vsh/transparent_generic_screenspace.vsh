...
VS_OUTPUT main(VS_INPUT i)
{
   ...
   // (12) output texcoords -----------------------------------------------------------------
   R_TEMP0.x = dot(V_POSITION, C_VIEWPROJ_X);   
   R_TEMP0.y = dot(V_POSITION, C_VIEWPROJ_Y);   
   R_TEMP0.zw = dot(V_POSITION, C_VIEWPROJ_W);   
   o.T0.x = dot(R_TEMP0, C_TEXTURE0_XFORM_X);   
   o.T0.y = dot(R_TEMP0, C_TEXTURE0_XFORM_Y);   
   o.T0.w = R_TEMP0.w;
