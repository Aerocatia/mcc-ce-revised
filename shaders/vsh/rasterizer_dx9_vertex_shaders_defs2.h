...
#define V_POSITION							float4(i.va_position.xyz, 1) // v0
#define V_NORMAL							i.va_normal   // v1
#define V_BINORMAL							i.va_binormal // v2
#define V_TANGENT							i.va_tangent  // v3
#define V_TEXCOORD							float4(i.va_texcoord.xy, 0, 1) // v4
#define V_ZERO								0
#define V_ONE								1
#define V_NODE_INDICES						i.va_node_indices   // v5
#define V_NODE0_INDEX						i.va_node_indices.x // v5.x
#define V_NODE1_INDEX						i.va_node_indices.y // v5.y
#define V_NODE2_INDEX						i.va_node_indices.z // v5.z
#define V_NODE3_INDEX						i.va_node_indices.w // v5.w
#define V_NODE_WEIGHTS						i.va_node_weights   // v6
#define V_NODE0_WEIGHT						i.va_node_weights.x // v6.x
#define V_NODE1_WEIGHT						i.va_node_weights.y // v6.y
#define V_NODE2_WEIGHT						i.va_node_weights.z // v6.z
#define V_NODE3_WEIGHT						i.va_node_weights.w // v6.w
#define V_INCIDENT_RADIOSITY				i.va_incident_radiosity // v7
#define V_LIGHTMAP_TEXCOORD					float4(i.va_texcoord2.xy, 0, 1) // v8
#define V_COLOR								i.va_color     // v9
#define V_COLOR2							i.va_color2    // v10
#define V_TEXCOORD2							float4(i.va_texcoord2.xy, 0, 1) // v8 // was v11, now shares V_LIGHTMAP_TEXCOORD
