...
VS_OUTPUT main(VS_INPUT i)
{
   ...
   R_POSITION.w = 1;   // necessary because we can't use DPH
   ...
   R_FOG_DENSITY.xy = 1 - R_FOG_DENSITY.xy;   // {1 - x, 1 - y}
   R_FOG_DENSITY.xyz = max(R_FOG_DENSITY.xyz, 0);   // clamp to zero
   R_FOG_DENSITY.xy = R_FOG_DENSITY.xy * R_FOG_DENSITY.xy;   // {(1 - x)^2, (1 - y)^2}
   R_FOG_DENSITY.xyz = min(R_FOG_DENSITY.xyz, 1);   // clamp to one
   R_FOG_DENSITY.x = R_FOG_DENSITY.x + R_FOG_DENSITY.y;   // (1 - x)^2 + (1 - y)^2
   R_FOG_DENSITY.x = min(R_FOG_DENSITY.x, 1);   // clamp to one
   R_FOG_DENSITY.xy = 1 - R_FOG_DENSITY.xy;   // {1 - (1 - x)^2 - (1 - y)^2, 1 - (1 - y)^2}
   R_FOG_DENSITY.xy = R_FOG_DENSITY.xy * R_FOG_DENSITY.xy;   // {(1 - (1 - x)^2 - (1 - y)^2)^2, (1 - (1 - y)^2)^2}
   ...
   R_FOG_DENSITY.xyzw = 1 - R_FOG_DENSITY.xyzw;   // (1 - Af),(1 - Pf)
