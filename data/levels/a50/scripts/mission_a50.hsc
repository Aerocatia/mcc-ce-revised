...
;	(if debug (print "migrating marines to the door"))
	...
	(sleep_until (or (> (ai_conversation_status grav_mus_locked_door) 4)(> (ai_conversation_status grav_mus_door_locked_alt) 4)))
...
;======== Breadcrumbs improved navpoints ========
(global short g_breadcrumb_nav_index 0)

(script dormant bcs_nav_points_a50
	; On the ramp the player snipes from
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(sleep_until (> (ai_conversation_status initial_orders) 0))
			(breadcrumbs_activate_team_nav_point_position "default" player 19.68 -16.16 89.26 "navpoint_0_1" 0.55)
			(sleep_until
				(or
					(volume_test_objects area2_trigger (players))
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_0_1")
			(set g_breadcrumb_nav_index 1)
		)
	)

	; Open area after first combat encounter
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(sleep_until (> g_breadcrumb_nav_index 1))
			(breadcrumbs_activate_team_nav_point_position "default" player -4 -40 88 "navpoint_1" 1)
			(sleep_until
				(or
					(volume_test_objects area3_trigger (players))
	...
	; Ledge the player needs to cross
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -25.17 -8.75 91 "navpoint_2" 1)
			(sleep_until
				(or
	...
	; narrow passage with 2 covenant
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 7 -2 97.1 "navpoint_3" 0.55)
			(sleep_until
				(or
					(volume_test_objects area5_trigger (players))
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 25.36 24.34 101 "navpoint_4" 1)
			(sleep_until
				(or
					(volume_test_objects gravity_pad_teleport_trigger (players))
	...
	; Large closed door inside the ship
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 6.31 -1.40 -23.39 "navpoint_5" 1)
	...
	; Door to upper area corridor
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -4.91 9.26 -21.80 "navpoint_5_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -4.91 9.26 -21.80) 2)
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_5_1")
			(set g_breadcrumb_nav_index 9)
		)
	)

	; Upper area corridor leading to the other side of the door
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 14.74 -1.41 -19.80 "navpoint_6" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 14.74 -1.41 -19.80) 2)
					(> g_breadcrumb_nav_index 9)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_6")
			(sleep_until (> g_breadcrumb_nav_index 9))
		)
	)

	; On the console that controls the door to let the marines go through
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player muster_bay_control 0)
			(sleep_until (> g_breadcrumb_nav_index 10))
			(breadcrumbs_deactivate_team_nav_point_object player muster_bay_control)
	...
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player muster_door_l2 0)
			(sleep_until (> g_breadcrumb_nav_index 12))
			(breadcrumbs_deactivate_team_nav_point_object player muster_door_l2)
		)
	)
	...
	(if (= g_breadcrumb_nav_index 13)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 25.21 -2.46 -24.35 "navpoint_7" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 25.21 -2.46 -24.35) 2)
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 32.93 2.14 -25.35 "navpoint_7_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 32.93 2.14 -25.35) 3)
	...
	(if (= g_breadcrumb_nav_index 15)
		(begin
			...
			(sleep_until
				(or
					(volume_test_objects hangar_entrance (players))
	...
	(if (= g_breadcrumb_nav_index 16)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 20 -64 -23.85 "navpoint_9" .5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 20 -64 -23) 3)
	...
	(if (= g_breadcrumb_nav_index 17)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 29.6 -51 -23 "navpoint_9_1" .3)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 29.6 -51 -23) 3)
					(> g_breadcrumb_nav_index 17)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_9_1")
	...
	(if (= g_breadcrumb_nav_index 18)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 26.84 -27.0 -23 "navpoint_9_2" .3)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 27 -26.5 -22.6) 3)
					(> g_breadcrumb_nav_index 18)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_9_2")
			(set g_breadcrumb_nav_index 19)
		)
	)

	; Winding paths to 3rd floor
	(if (= g_breadcrumb_nav_index 19)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 23.10 -13.90 -21.85 "navpoint_9_3" .55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 23.10 -13.90 -21.85) 3)
					(> g_breadcrumb_nav_index 19)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_9_3")
	...
	(if (= g_breadcrumb_nav_index 20)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player hangar_third_door_a 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) hangar_third_door_a) 3)
					(> g_breadcrumb_nav_index 20)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player hangar_third_door_a)
	...
	(if (= g_breadcrumb_nav_index 21)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player hangar_door_c 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) hangar_door_c) 2)
					(> g_breadcrumb_nav_index 21)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player hangar_door_c)
	...
	(if (= g_breadcrumb_nav_index 22)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player control_door_a 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) control_door_a) 2)
					(> g_breadcrumb_nav_index 22)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player control_door_a)
			(sleep_until (> g_breadcrumb_nav_index 22))
		)
	)

	; In maze leading to cells
	(if (= g_breadcrumb_nav_index 23)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -10.70 -73.45 -19.85 "navpoint_10_1" .55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -10.70 -73.45 -19.85) 2)
	...
	(if (= g_breadcrumb_nav_index 24)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 11.76 -96.99 -19.35 "navpoint_10_2" .55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 11.76 -96.99 -19.35) 2)
					(> g_breadcrumb_nav_index 24)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_10_2")
	...
	(if (= g_breadcrumb_nav_index 25)
		(begin
			...
			(breadcrumbs_deactivate_team_nav_point_object player prison_d_switch)
	...
	(if (= g_breadcrumb_nav_index 27)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -6.50 -60.00 -19.30 "navpoint_13" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -6.50 -60.00 -19.30) 2)
					(> g_breadcrumb_nav_index 27)
				)
			)
	...
	(if (and (> (ai_living_count covenant_area2/turret_gunner_a) 0)
		...
		(begin_random
			(begin (ai_go_to_vehicle covenant_area2/turret_gunner_a area2_turret_a gunner)
				  (if (> g_breadcrumb_nav_index 0)
					(breadcrumbs_activate_team_nav_point_object default_red player (unit (list_get (ai_actors covenant_area2/turret_gunner_a) 0)) 0.6)
				  )
			  	  (sleep default_turret_gunner_delay))
			(begin (ai_go_to_vehicle covenant_area2/turret_gunner_b area2_turret_b gunner)
			  	  (sleep default_turret_gunner_delay)
				  (if (> g_breadcrumb_nav_index 0)
					(breadcrumbs_activate_team_nav_point_object default_red player (unit (list_get (ai_actors covenant_area2/turret_gunner_b) 0)) 0.6)
				  ))))
	)
...
(script dormant ini_gun_runner
	...
	(if (> (ai_living_count covenant_area2/gun_runner) 0)
		...
		(breadcrumbs_activate_team_nav_point_object default_red player (unit (list_get (ai_actors covenant_area2/gun_runner) 0)) .6)))
...
;	(enc_hangar_first_s)
	...
	(if (= (volume_test_objects hangar_first_trigger_a (players)) 0)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_object "default" player hangar_exit 0)
		)
	)
	(sleep 60)
	...
	(breadcrumbs_deactivate_team_nav_point_object player hangar_exit)
...
;	(wake ini_area5_cov_retreat)
   ...
   (if (mcc_mission_segment "cine2_into_the_belly") (sleep 1))
	...
	(ai_detach (player0))
	(breadcrumbs_deactivate_team_nav_point player "navpoint_lift")
	)
...
;	(sleep_until (< (ai_living_count muster_bay_covenant_bottom) 3))
	...
	(if muster_door_nav
		(begin
			(activate_team_nav_point_object "default_red" player muster_door_l2 .3)
...
(script dormant mission_hangar
	...
	(deactivate_team_nav_point_object player muster_door_l2)
	(deactivate_team_nav_point_object player muster_bay_control)
	(if (< g_breadcrumb_nav_index 13) (set g_breadcrumb_nav_index 13))
...
;	(sleep_until (volume_test_objects control_music_trigger (players)))
	...
	(if (not (volume_test_objects prison_trigger (players)))
		(begin
			...
			(breadcrumbs_activate_team_nav_point_object "default" player control_door_d 0)
		)
	)
	(sleep_until (= (ai_living_count control_covenant) 0))
...
;	(device_set_power control_door_d 0)
	...
	(breadcrumbs_deactivate_team_nav_point_object player control_door_d)
