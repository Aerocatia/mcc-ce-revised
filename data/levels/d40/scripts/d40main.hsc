...
(script dormant breadcrumbs_nav_points_d40
	; On narrow tunnel leading deeper into ship
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -42.2 34 2 "navpoint_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -41 34 2) 2)
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -40.1 31.3 0.0 "navpoint_1_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -40.1 31.3 0.0) 2)
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player enc1_4_door 0)
			(sleep_until (> g_breadcrumb_nav_index 2))
			(breadcrumbs_deactivate_team_nav_point_object player enc1_4_door)
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 0 0 0 "navpoint_2" 0.55)
			(sleep_until
				(or
					(> g_breadcrumb_nav_index 4)
					(< (objects_distance_to_position (players) 0 0 0) 3.5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_2")
			(sleep_until (> g_breadcrumb_nav_index 5) 0 340)
			(set g_breadcrumb_nav_index 6)
		)
	)

	; After cutscene finishes, leading back towards engine room
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -45.7 0 1.5 "navpoint_3" 0.55)
			(sleep_until (> g_breadcrumb_nav_index 6))
			(breadcrumbs_deactivate_team_nav_point player "navpoint_3")
		)
	)

	; Door to tunnel section
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -54.79 -19.47 2.03 "navpoint_3_5" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -54.79 -19.47 2.03) 2)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_3_5")
			(set g_breadcrumb_nav_index 8)
		)
	)

	; Leading out of tunnel section
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -61.55 -28.80 2.03 "navpoint_3_6" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -61.55 -28.80 2.03) 2)
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_3_6")
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -63 -28 2) 3)
...
(script static void trench_scene_continue
	...
	(breadcrumbs_activate_team_nav_point_flag "default" player nav_endpoint 0)
)
...
;	(if debug (print "enc6_6_1"))
	...
	(breadcrumbs_deactivate_team_nav_point_flag player nav_midpoint)
...
;	(D40_340_Cortana)
   ...
   (mcc_mission_segment "17_escape")
	...
	(breadcrumbs_activate_team_nav_point_flag "default" player nav_midpoint 0)
)
...
(script static void enc5_1_mark_manifolds
	...
	(breadcrumbs_deactivate_team_nav_point_flag player nav_cntrl_n1)
	...
	(if
		...
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player enc5_1_manifold_n1 0)
		)
		(begin
	...
	(if
		...
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player enc5_1_manifold_n3 0)
		)
		(begin
	...
	(if
		...
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player enc5_1_manifold_s1 0)
		)
		(begin
	...
	(if
		...
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player enc5_1_manifold_s3 0)
		)
		(begin
...
(script static void enc5_1_mark_controls
	...
	(if (= (device_get_power enc5_1_controln1) 1)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player nav_cntrl_n1 0)
		)
		(begin
			(deactivate_team_nav_point_flag player nav_cntrl_n1)
			(breadcrumbs_deactivate_team_nav_point_flag player nav_cntrl_n1)
	...
	(if (= (device_get_power enc5_1_controln3) 1)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player nav_cntrl_n3 0)
		)
		(begin
			(deactivate_team_nav_point_flag player nav_cntrl_n3)
			(breadcrumbs_deactivate_team_nav_point_flag player nav_cntrl_n3)
	...
	(if (= (device_get_power enc5_1_controls1) 1)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player nav_cntrl_s1 0)
		)
		(begin
			(deactivate_team_nav_point_flag player nav_cntrl_s1)
			(breadcrumbs_deactivate_team_nav_point_flag player nav_cntrl_s1)
	...
	(if (= (device_get_power enc5_1_controls3) 1)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag "default" player nav_cntrl_s3 0)
		)
		(begin
			(deactivate_team_nav_point_flag player nav_cntrl_s3)
			(breadcrumbs_deactivate_team_nav_point_flag player nav_cntrl_s3)
...
(script startup mission
   ...
   (mcc_mission_segment "01_start")
	...
	(if (breadcrumbs_nav_points_active)
		(wake breadcrumbs_nav_points_d40)
	)
)
