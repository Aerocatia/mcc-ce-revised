...
(script dormant improved_nav_points_a10_tut
	(sleep_until (volume_test_objects tutorial_skip_1 (players)))
...
(script dormant tutorial_moving_1
	...
	(if (and (breadcrumbs_nav_points_active) (and (not (game_is_cooperative)) (= (game_difficulty_get) normal)) ) (display_scenario_help 6))
...
(script continuous test_looking_cycle_script
...
;		(object_type_predict "effects\explosions\medium explosion")
	...
	(if (breadcrumbs_nav_points_active)
		(wake improved_nav_points_a10_tut)
	)
