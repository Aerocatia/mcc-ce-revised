...
(script dormant breadcrumbs_nav_points_c20
	...
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 13.29 13.22 -4.9 "navpoint_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 13.29 13.22 -4.9) 3)
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 14.15 -14.16 -4.9 "navpoint_2" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 14.15 -14.16 -4.9) 3)
		...
		(begin
			...
			(sleep_until
				(or
					...
					(< (objects_distance_to_position (players) 37 -8 11.5) 3)
	...
	(if (= g_breadcrumb_nav_index 15)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_position "default" player -83.74 61.37 41.9 "navpoint_16" 0.55)

			(sleep_until
				(or
					(< (objects_distance_to_position (players) -83.74 61.37 41.9) 3)
					(> g_breadcrumb_nav_index 15)
				)
			)
	...
	(if (= g_breadcrumb_nav_index 16)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -77.15 38.38 43.4 "navpoint_16_5" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -77.15 38.38 43.4) 3)
