...
;=========== Breadcrumbs revised navpoint triggers ===========
(global short g_breadcrumb_nav_index 0)

(script dormant breadcrumbs_nav_points_c10
	; Navpoint leading player to structure
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -112 -65 40 "navpoint_0_5" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -112 -65 40) 5)
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_0_5")
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -78.20 -6.35 43.40 "navpoint_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -78.20 -6.35 43.40) 5)
					(volume_test_objects int_a_trigger_3 (players))
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			; Wait for the elevator to come up before adding navpoint (to stop players walking into the elevator shaft)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point_object player lift_a_cont_a)
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(sleep_until
				(or
					(= (device_get_position lift_a) 1)
					(> g_breadcrumb_nav_index 3)
				) 1
			)
			(breadcrumbs_activate_team_nav_point_object "default" player post_lifta_door_2 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) post_lifta_door_2) 2)
					(> g_breadcrumb_nav_index 3)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player post_lifta_door_2)
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player bsp1_device_20 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) bsp1_device_20) 2)
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player bsp1_device_20)
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -18.02 -35.70 0.00 "suicidal_marine" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -18.02 -35.70 0.00) 2)
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "suicidal_marine")
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -13.11 -56.68 0.90 "after_marine" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -13.11 -56.68 0.90) 2)
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "after_marine")
			(set g_breadcrumb_nav_index 7)
		)
	)

	; Upstairs section of panicking marine
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player bsp2_device_18 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) bsp2_device_18) 1)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player bsp2_device_18)
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player bsp2_device_21 .15)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) bsp2_device_21) 2)
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player bsp2_device_21)
			(sleep_until (> g_breadcrumb_nav_index 8) 0 180)
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -18.0 -13.9 0.5 "navpoint_5" 0)
			(sleep_until
				(or
					(volume_test_objects control_lab_trigger (players))
	...
	; After flood breaks open door
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player control_door_bashed_a .15)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) control_door_bashed_a) 2)
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player control_door_bashed_a)
			(set g_breadcrumb_nav_index 12)
		)
	)

	; On flood combat area
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(wake bcs_split_route_top)
			(wake bcs_split_route_bottom)
			;(breadcrumbs_activate_team_nav_point_position "default" player -25.51 -27.21 1.9 "navpoint_6" 0.55)
			;(breadcrumbs_activate_team_nav_point_position "default" player -25.51 -27.21 0.0 "navpoint_6_1" 0.55)
			;(sleep_until
			;	(or
			;		(volume_test_objects hall_c_top_trigger (players))
	...
	; 	(begin
	; 		(breadcrumbs_activate_team_nav_point_position "default" player -39.4 -14.2 0.3 "navpoint_7" 0.5)
	; 		(breadcrumbs_activate_team_nav_point_position "default" player -39.4 -14.7 2.1 "navpoint_7_1" 0.5)
	; 		(sleep_until
	; 			(or
	; 				(volume_test_objects int_a_ante_a_trigger (players))
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player lift_b_cont_a .1)
			(sleep_until (> g_breadcrumb_nav_index 14))
			(breadcrumbs_deactivate_team_nav_point_object player lift_b_cont_a)
	...
	(if (= g_breadcrumb_nav_index 16)
		(begin 
			...
			(breadcrumbs_activate_team_nav_point_object "default" player bsp3_device_18 .1)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) bsp3_device_18) 2)
					(> g_breadcrumb_nav_index 16)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player bsp3_device_18)
	...
	(if (= g_breadcrumb_nav_index 17)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player bsp3_device_20 .1)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) bsp3_device_20) 1)
					(> g_breadcrumb_nav_index 17)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player bsp3_device_20)
	...
	(if (= g_breadcrumb_nav_index 18)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player bsp3_device_23 .1)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) bsp3_device_23) 2)
					(> g_breadcrumb_nav_index 18)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player bsp3_device_23)
	...
	(if (= g_breadcrumb_nav_index 19)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player last_door_a .1)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) last_door_a) 2)
					(> g_breadcrumb_nav_index 19)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player last_door_a)
	...
	(if (= g_breadcrumb_nav_index 20)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player brdige_e_cont_a .1)
			(sleep_until
				(or
					(= (device_get_position bridge_e) 1)
					(> g_breadcrumb_nav_index 20)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player brdige_e_cont_a)
	...
	(if (= g_breadcrumb_nav_index 21)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player lift_d_cont_a .1)
			(sleep_until
				(or
					(= (device_get_position lift_d) 1)
					(> g_breadcrumb_nav_index 21)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player lift_d_cont_a)
	...
	(if (= g_breadcrumb_nav_index 22)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -134.26 61.71 2 "navpoint_12" 0.5)
			(sleep_until
				(or
					(volume_test_objects monitor_trigger (players))
...
;========== Split path nav point section ==========
(global boolean bcs_nav_split_down false)

(script dormant bcs_split_route_top
	(breadcrumbs_activate_team_nav_point_position "default" player -26.07 -27.21 1.9 "navpoint_6_top" 0.55)
	(sleep_until
		(or
			(< (objects_distance_to_object (players) post_helmet_door_4) 1)
			(> g_breadcrumb_nav_index 12)
			(= bcs_nav_split_down TRUE)
		)
	)
	(breadcrumbs_deactivate_team_nav_point player "navpoint_6_top")
	(breadcrumbs_deactivate_team_nav_point player "navpoint_6_bottom")

	(if (= bcs_nav_split_down FALSE)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -39.42 -19.14 1.9 "navpoint_6_top_2" 0.55)
			(wake bcs_split_top_fall_detection)
		)
	)

	(sleep_until
		(or
			(< (objects_distance_to_position (players) -39.42 -19.14 1.9) 1)
			(> g_breadcrumb_nav_index 12)
			(= bcs_nav_split_down TRUE)
		)
	)
	(breadcrumbs_deactivate_team_nav_point player "navpoint_6_top_2")
...
(script dormant bcs_split_top_fall_detection
	(sleep_until
		(or
	...
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(set bcs_nav_split_down TRUE)
			(wake bcs_split_route_bottom_2)
		)
	)
	)

(script dormant bcs_split_route_bottom
	(breadcrumbs_activate_team_nav_point_position "default" player -26.07 -27.21 0.0 "navpoint_6_bottom" 0.55)
	(sleep_until
		(or
			(< (objects_distance_to_object (players) bsp1_device_bsp2_device_1) 1)
			(> g_breadcrumb_nav_index 12)
		)
	)
	(breadcrumbs_deactivate_team_nav_point player "navpoint_6_top")
	...
	(if (= g_breadcrumb_nav_index 12)
		(breadcrumbs_activate_team_nav_point_position "default" player -39.42 -19.14 0.0 "navpoint_6_bottom_2" 0.55)
	)

	(sleep_until
		(or
			(< (objects_distance_to_position (players) -39.42 -19.14 0.0) 1)
			(> g_breadcrumb_nav_index 12)
		)
	)
	(breadcrumbs_deactivate_team_nav_point player "navpoint_6_bottom_2")
...
(script dormant bcs_split_route_bottom_2
	(breadcrumbs_activate_team_nav_point_position "default" player -35.73 -1.56 1.9 "navpoint_6_bottom_3" 0.55)
	(sleep_until
		(or
			(< (objects_distance_to_position (players) -35.73 -1.56 1.9) 2)
			(> g_breadcrumb_nav_index 12)
		)
	)
	(breadcrumbs_deactivate_team_nav_point player "navpoint_6_bottom_3")
	(set g_breadcrumb_nav_index 14)
	)

	; AG_TODO - navpoint on door elading to next nav (set index 14 here)
