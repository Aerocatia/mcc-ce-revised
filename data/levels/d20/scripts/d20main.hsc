...
(script dormant breadcrumbs_nav_points_d20
	; Accross the hole the player has to jump in
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player enc1_5_door 0)
			(sleep_until (> g_breadcrumb_nav_index 0))
			(sleep_until (> g_breadcrumb_nav_index 1) 1 60)
			(breadcrumbs_deactivate_team_nav_point_object player enc1_5_door)
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 63.16 -50.56 -26.37 "navpoint_1_5" 0.55)
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 30.99 -45.10 -23.31 "navpoint_1_6" 0.55)
			(sleep_until (> g_breadcrumb_nav_index 3))
			(breadcrumbs_deactivate_team_nav_point player "navpoint_1_6")
			(sleep_until (> g_breadcrumb_nav_index 4))
		)
	)

	; After Keyes cinematic
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 14.65 -101.14 -73.80 "navpoint_5_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 14.65 -101.14 -73.80) 2)
	...
	; On door leading to hangar
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 7.02 -92.22 -74.30 "navpoint_5_2" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 7.02 -92.22 -74.30) 2)
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_5_2")
			(set g_breadcrumb_nav_index 7)
		)
	)

	; Near end of level towards hangar
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -3.99 -80.15 -75.30 "navpoint_6" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -3.99 -80.15 -75.30) 2)
...
;	/JLG
   ...
   (mcc_mission_segment "01_start")
	...
	(if (breadcrumbs_nav_points_active)
		(wake breadcrumbs_nav_points_d20)
	)
)
