...
(script static void waypoint_1
	...
	(breadcrumbs_activate_team_nav_point_flag "default" player waypoint1 0.55)
)
...
(script static void waypoint_2
	...
	(breadcrumbs_activate_team_nav_point_flag "default" player waypoint2 0.55)
)
...
(script static void waypoint_3
	...
	(breadcrumbs_activate_team_nav_point_flag "default" player waypoint3 0.5)
)
...
(script dormant breadcrumbs_nav_points_c40
	; First door control panel
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(sleep_until (> g_breadcrumb_nav_index 0))
			(breadcrumbs_activate_team_nav_point_position "default" player 365.67 -689.78 74.52 "navpoint_door1" 0)
			(sleep_until (> g_breadcrumb_nav_index 1))
			(breadcrumbs_deactivate_team_nav_point player "navpoint_door1")
		)
	)

	; Second door control panel
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 358.43 -657.12 74.52 "navpoint_door2" 0)
			(sleep_until (> g_breadcrumb_nav_index 2))
			(breadcrumbs_deactivate_team_nav_point player "navpoint_door2")
		)
	)

	; Third door control panel
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 343.15 -651.86 74.52 "navpoint_door3" 0)
			(sleep_until (> g_breadcrumb_nav_index 3))
			(breadcrumbs_deactivate_team_nav_point player "navpoint_door3")
		)
	)
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_position "default" player 252.0 -635.5 104.0 "navpoint_1" 0)
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 297.6 -605.3 70.9 "navpoint_2" 0)
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 279.69 -556.66 70.34 "navpoint_3" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 279.69 -556.66 70.34) 2)
	...
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 286.2 -467.5 71 "navpoint_4" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 286.1 -471.1 70.9) 2)
	...
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 269.74 -556.30 70.34 "navpoint_5" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 269.74 -556.30 70.34) 3)
	...
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(sleep_until
				(or
					(< (objects_distance_to_object (players) door_b3) 3)
					(> g_breadcrumb_nav_index 12)
				)
			)
			(breadcrumbs_activate_team_nav_point_object "default" player lift_c_control_b 0.1)
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 241.56 -583.92 22.34) 5)
					(> g_breadcrumb_nav_index 14)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 269.75 -556.70 22.34 "navpoint_6" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 269.75 -556.70 22.34) 2)
					(> g_breadcrumb_nav_index 14)
				)
			)
	...
	; guiding to banshee 3
	(if (= g_breadcrumb_nav_index 19)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 137.56 -455.32 22.56 "navpoint_banshee3" 0.55)
			(sleep_until (> g_breadcrumb_nav_index 19))
			(breadcrumbs_deactivate_team_nav_point player "navpoint_banshee3")
		)
	)

	(if (= g_breadcrumb_nav_index 20)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 193.95 -449.12 86.75 "waypoint4" 0.55)
	...
	(if (= g_breadcrumb_nav_index 21)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player tun_garage_1_con_a .1)
			(sleep_until
				(or
					(!= (device_get_position tun_garage_1) 0)
					(> g_breadcrumb_nav_index 21)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player tun_garage_1_con_a)
	...
	(if (= g_breadcrumb_nav_index 22)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player tun_garage_2_con_a .1)
			(sleep_until
				(or
					(!= (device_get_position tun_garage_2) 0)
					(> g_breadcrumb_nav_index 22)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player tun_garage_2_con_a)
	...
	(if (= g_breadcrumb_nav_index 23)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player tun_garage_3_con_b .1)
			(sleep_until
				(or
					(!= (device_get_position tun_garage_3) 0)
					(> g_breadcrumb_nav_index 23)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player tun_garage_3_con_b)
	...
	(if (= g_breadcrumb_nav_index 24)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 27.95 -50.23 0.42 "navpoint_12_5" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 27.95 -50.23 0.42) 3)
					(> g_breadcrumb_nav_index 24)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_12_5")
	...
	(if (= g_breadcrumb_nav_index 25)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 171.10 -71.98 32.00 "waypoint6" 0.55)
			(sleep_until (> g_breadcrumb_nav_index 25))
			(breadcrumbs_deactivate_team_nav_point player "waypoint6")
		)
	)
)
...
(script dormant e8_b
	...
	(breadcrumbs_deactivate_team_nav_point_flag player waypoint3)
...
;	(volume_teleport_players_not_inside null_volume s0)
   ...
   (if (mcc_mission_segment "cine1_intro") (sleep 1))
	...
	(if (breadcrumbs_nav_points_active)
		(wake breadcrumbs_nav_points_c40)
	)
	(wake section1)
	(wake music_c40)
	(fade_in 0 0 0 0)
