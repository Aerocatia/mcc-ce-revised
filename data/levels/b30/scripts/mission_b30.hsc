...
;=========== breadcrumbs navpoint triggers ===========
(global short g_breadcrumb_nav_index 0)

(script dormant breadcrumbs_nav_points_b30
	(if (= g_breadcrumb_nav_index 0)
		(sleep_until (> g_breadcrumb_nav_index 2))
	)

	; Silent Cartographer entrance
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 22 -22 10 "shaftA_entrance" 0.55)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point player "shaftA_entrance")
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 2.21 -22.89 2 "shaftA_door_locked" 0.33)
			(sleep_until (> g_breadcrumb_nav_index 4))
			(breadcrumbs_deactivate_team_nav_point player "shaftA_door_locked")
			(sleep_until
				(or
					(volume_test_objects shaftA_platform (players))
					(> g_breadcrumb_nav_index 5)
				)
			)

			; If player walked back outside before conversation finished, skip the next navpoint
			(if (= g_breadcrumb_nav_index 5)
				(begin
					(sleep_until
						(or
							(< 4 (ai_conversation_status shaftA_known_locked))
							(> g_breadcrumb_nav_index 5)
						)
					1)
					(if (< g_breadcrumb_nav_index 7) (set g_breadcrumb_nav_index 7))
				)
			)
		)
	)
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 20 -22 10 "shaftA_platform" 0.33)
			(sleep_until
				(or
					(volume_test_objects shaftA_platform (players))
			...
			(breadcrumbs_deactivate_team_nav_point player "shaftA_platform")
			(if (< g_breadcrumb_nav_index 7) (set g_breadcrumb_nav_index 7))
		)
	)

	; Inner island entrance path
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 34 49 8 "valley_entrance" 0.55)
			(sleep_until
				(or
					(volume_test_objects valley_entrance (players))
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "valley_entrance")
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -6 26 13 "shaftB_entrance" 0.55)
			(sleep_until
				(or
					(volume_test_objects shaftB_entrance (players))
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "shaftB_entrance")
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player shaftb_control .1)
	...
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(sleep_until
				(or
					(volume_test_objects shaftB_entrance_inv (players))
	...
	; On corridors leading down inside structure.
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 2.19 -22.89 2.13 "navpoint_1_1" 0.55)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point player "navpoint_1_1")
			(set g_breadcrumb_nav_index 12)
		)
	)

	; On corridors leading down inside structure. Attached to door that closes before player can reach inside
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 13.22 -14.38 2.13 "navpoint_2" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 13.22 -14.38 2.13) 2)
	...
	(if (= g_breadcrumb_nav_index 13)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 24.09 -25.22 -2.87 "navpoint_2_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 24.09 -25.22 -2.87) 3)
					(volume_test_objects shaftA_jig (players))
					(> g_breadcrumb_nav_index 13)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_2_1")
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 17.07 -29.89 -8.87 "navpoint_3" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 17.07 -29.89 -8.87) 2)
	...
	(if (= g_breadcrumb_nav_index 15)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 21.4 -28 -13 "navpoint_4" 0.55)
			(sleep_until
				(or
					(volume_test_objects shaftA_control (players))
	...
	(if (= g_breadcrumb_nav_index 16)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player shafta_map_control .1)
			(sleep_until (> g_breadcrumb_nav_index 16))
			(breadcrumbs_deactivate_team_nav_point_object player shafta_map_control)
		)
	)

	; Ramp leading out of map control room
	(if (= g_breadcrumb_nav_index 17)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 12.42 -19.56 -13.37 "navpoint_4_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 12.42 -19.56 -13.37) 2)
					(volume_test_objects shaftA_ramp (players))
					(> g_breadcrumb_nav_index 17)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_4_1")
	...
	(if (= g_breadcrumb_nav_index 18)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 10.2 -30.22 -8.7 "navpoint_5" 0.3)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 17 -28 -8) 3)
					(< (objects_distance_to_position (players) 10 -28 -8) 3)
	...
	; Navpoint back on door that was closed and locked early on
	(if (= g_breadcrumb_nav_index 19)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 7.2 -14.3 -2 "navpoint_6" 0.3)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 7.2 -14.3 -2) 3)
	...
	(if (= g_breadcrumb_nav_index 20)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 2.26 -27.23 2.2 "navpoint_7" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 2.26 -27.23 2.2) 3)
	...
	(if (= g_breadcrumb_nav_index 21)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player extraction_pelican 0.1)
			(sleep_until (> g_breadcrumb_nav_index 21))
			(breadcrumbs_deactivate_team_nav_point_object player extraction_pelican)
		)
	)
	)

(script dormant breadcrumbs_nav_warthog_route_1
	(breadcrumbs_activate_team_nav_point_position "default" player 33.89 70.91 0.62 "island_warthog_route_1" 1)
	(sleep_until
		(or
			(volume_test_objects beach_4 (players))
	...
	(if (< g_breadcrumb_nav_index 3) (set g_breadcrumb_nav_index 3))
	)

(script dormant breadcrumbs_nav_warthog_route_2
	(breadcrumbs_activate_team_nav_point_position "default" player 20.14 -64.25 7.26 "island_warthog_route_2" 1)
	(sleep_until
		(or
	...
	(breadcrumbs_deactivate_team_nav_point player "island_warthog_route_2")
	; if g_breadcrumb_nav_index is not 0, "island_warthog_route_1" was reached first. In this case we don't want to changed the nav index here
	(if (= g_breadcrumb_nav_index 0) (set g_breadcrumb_nav_index 3))
	)
...
;	(ai_attach jeep_gunner beach_lz_marine)
	...
	(breadcrumbs_deactivate_team_nav_point_object player jeep)
...
;	(sleep_until (= 0 (ai_going_to_vehicle jeep)) delay_dawdle)
	...
	(sleep 45)
	(wake breadcrumbs_nav_warthog_route_1)
	(wake breadcrumbs_nav_warthog_route_2)
	(set mark_map true)
...
(script startup main_b30
	...
	(if (breadcrumbs_nav_points_active)
		(wake breadcrumbs_nav_points_b30)
	)
