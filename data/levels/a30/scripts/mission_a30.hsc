...
(script dormant breadcrumbs_nav_points_a30
	; Across the intial bridge
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(sleep_until (> g_breadcrumb_nav_index 0))
			(breadcrumbs_activate_team_nav_point_position "default" player -0.25 -98.25 57.50 "bridge" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -0.25 -98.25 57.50) 3)
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "bridge")
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 36 12 73 "hillside" 1)
			(sleep_until
				(or
					(volume_test_objects first_trigger_1 (players))
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "hillside")
			(set g_breadcrumb_nav_index 3)
		)
	)

	; Defend near structure
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 7 48 64 "structure_defend" 0)
			(sleep_until
				(or
					(volume_test_objects first_retreat (players))
					(> g_breadcrumb_nav_index 3)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "structure_defend")
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -85 -54 40 "tunnel_entrance" 1)
			(sleep_until
				(or
					(volume_test_objects cave_entrance (players))
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "tunnel_entrance")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -95.81 -16.01 36.00 "warthog_jump" 1)
			(sleep_until
				(or
					(< (objects_distance_to_flag (players) cave_flag) 14)
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "warthog_jump")
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -148.31 14.00 30.00 "control_ramp" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -148.31 14.00 30.00) 2)
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "control_ramp")
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player bridge_control .2)
			(sleep_until (> g_breadcrumb_nav_index 7))
			(breadcrumbs_deactivate_team_nav_point_object player bridge_control)
		)
	)
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -384.20 41.24 48 "tunnel_exit" 1)
			(sleep_until
				(or
					(volume_test_objects cave_exit_fat (players))
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "tunnel_exit")
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(sleep_until (> g_breadcrumb_nav_index 9) 0 10)
			(bcs_activate_rescue_navs)
		)
	)
	)

(script static void bcs_activate_rescue_navs
	(begin
		(if (not global_cliff_end)	(breadcrumbs_activate_team_nav_point_position "default" player -518.84 56.70 63.88 "cliff" 0.55))
		(if (not global_rubble_end)	(breadcrumbs_activate_team_nav_point_position "default" player -376 170 67 "rubble" 0.55))
		(if (not global_river_end)	(breadcrumbs_activate_team_nav_point_position "default" player -565 206 76 "river" 0.55))
	)
	)

(script static void bcs_deactivate_rescue_navs
	(begin
		(breadcrumbs_deactivate_team_nav_point player "cliff")
		(if (not global_rubble_start) (breadcrumbs_deactivate_team_nav_point player "rubble"))
		(if (not global_river_start) (breadcrumbs_deactivate_team_nav_point player "river"))
	)
	)
...
(script dormant mission_extraction_cliff
	...
	(breadcrumbs_activate_team_nav_point_object "default" player foehammer_cliff 0.55)
...
(script dormant mission_extraction_rubble
	...
	(breadcrumbs_activate_team_nav_point_object "default" player foehammer_rubble 0)
...
(script dormant mission_extraction_river
	...
	(breadcrumbs_activate_team_nav_point_object "default" player foehammer_river 1)
...
(script dormant obj_cliff_all_killed
	...
	(breadcrumbs_deactivate_team_nav_point player "cliff_1")
	(breadcrumbs_deactivate_team_nav_point player "cliff_2")
	(sleep 60)
...
(script dormant mission_cliff
	...
	(bcs_deactivate_rescue_navs)
	(breadcrumbs_activate_team_nav_point_position "default" player -533.0 74.24 63.88 "cliff_1" 0.55)
	(breadcrumbs_activate_team_nav_point_position "default" player -517.92 37.97 63.88 "cliff_2" 0.55)
...
(script dormant obj_rubble_all_killed
	...
	(breadcrumbs_deactivate_team_nav_point player "rubble")
	(sleep 60)
...
(script dormant obj_river_all_killed
	...
	(breadcrumbs_deactivate_team_nav_point player "river")
	(sleep 60)
...
(script continuous cont_banshee_kill_script
