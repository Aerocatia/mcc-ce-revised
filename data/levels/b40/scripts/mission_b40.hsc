...
(script dormant breadcrumbs_nav_points_b40
	; Down corridor leading into structure
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 44.7 -75 48 "navpoint_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 44 -75 48) 3)
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 37 -100 48 "navpoint_2" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 37 -100 48) 2)
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 22.43 -103.46 48.2 "navpoint_3" .5)
			(sleep_until
				(or
					(= (device_group_get lift_a_position) 1)
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(sleep_until
				(or
					(volume_test_objects a2_bottom_save (players))
					(> g_breadcrumb_nav_index 3)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 44.81 -74.94 0 "navpoint_4" 0.55)

			(sleep_until
				(or
					(< (objects_distance_to_object (players) ext_a_door) 3)
					(> g_breadcrumb_nav_index 3)
				)
			)
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 109.89 -39.36 0.58 "navpoint_4_1" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 109.89 -39.36 0.58) 4)
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 165.71 -187.71 -11.05 "navpoint_5" 0.65)
			(sleep_until
				(or
					(= (device_group_get garagedoor_a_position) 1)
	...
	; On next console for opening doors
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 198.28 -277.06 -11.05 "navpoint_6" 0.65)
			(sleep_until
				(or
					(= (device_group_get garagedoor_c_position) 1)
	...
	; Further out to open area
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 161 -400 20 "navpoint_7" 1)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 161 -400 20) 9)
	...
	; Where player encounters marines
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 179 -520 12 "navpoint_8" 1)
			(sleep_until
				(or
					(volume_test_objects ext_b_b_floor_trigger (players))
	...
	; Door outside area B leading inside
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 269.75 -556.3 22.34 "navpoint_9" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 269.75 -556.3 22.34) 3)
	...
	; On console with interactable button
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 240.82 -585 22.34 "navpoint_10" .7)
			(sleep_until
				(or
					(= (device_group_get lift_c_position) 1)
	...
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 269.73 -505.87 70.34 "navpoint_11" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 269.73 -505.87 70.34) 3)
	...
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 283 -465.8 71 "navpoint_12" 0.2)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 283 -466 71) 3)
	...
	(if (= g_breadcrumb_nav_index 13)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 279.71 -556.29 70.34 "navpoint_13" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 279.71 -556.29 70.34) 3)
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player  299 -581.5 70 "navpoint_14" 0.55)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 299 -581 71) 3)
	...
	(if (= g_breadcrumb_nav_index 15)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 286.25 -681.06 70.34 "navpoint_15" 0.65)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 286 -680 71) 3)
	...
	(if (= g_breadcrumb_nav_index 16)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 263.85 -709.83 70.34 "navpoint_16" 0.7)
			(sleep_until
				(or
					(= (device_group_get lift_d_position) 1)
	...
	(if (= g_breadcrumb_nav_index 17)
		(begin
			(sleep_until
				(or
					(volume_test_objects c1_bottom_trigger (players))
					(> g_breadcrumb_nav_index 17)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 286.3 -681.46 54 "navpoint_17" 1)

			(sleep_until
				(or
					(< (objects_distance_to_position (players) 286 -682 54) 3)
					(> g_breadcrumb_nav_index 17)
				)
			)
	...
	(if (= g_breadcrumb_nav_index 18)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 338.66 -658.5 74 "navpoint_18" .55)
			(sleep_until
				(or
					(= (device_group_get control_door_a_position) 1)
	...
	(if (= g_breadcrumb_nav_index 19)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 359.50 -658.13 74 "navpoint_19" .55)
			(sleep_until
				(or
					(= (device_group_get control_door_c_position) 1)
	...
	(if (= g_breadcrumb_nav_index 20)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 359.50 -685.41 74 "navpoint_19" .55)
			(sleep_until
				(or
					(= (device_group_get control_door_d_position) 1)
...
(script dormant ini_ext_a_banshee
	...
	; NOTE: the line below never actually worked, due to the encounter not being active at the time of the function call. This is a legacy bug.
	; If it is ever fixed, intentionally or not, it will break this legacy glitch: https://www.youtube.com/watch?v=RO6D9xG7818
	; See: https://www.youtube.com/watch?v=HsZ5qB_TQDQ
